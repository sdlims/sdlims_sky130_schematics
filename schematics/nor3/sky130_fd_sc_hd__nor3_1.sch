...
C {ipin.sym} -340 -160 0 0 {name=p19 lab=VGND}
C {ipin.sym} -340 -140 0 0 {name=p20 lab=VNB}
C {ipin.sym} -340 -120 0 0 {name=p21 lab=VPB}
C {ipin.sym} -340 -100 0 0 {name=p22 lab=VPWR}
