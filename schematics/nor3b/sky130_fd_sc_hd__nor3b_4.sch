...
C {ipin.sym} -580 -340 0 0 {name=p1 lab=A}
C {ipin.sym} -580 -320 0 0 {name=p18 lab=B}
C {ipin.sym} -610 -150 0 0 {name=p14 lab=C_N}
C {ipin.sym} -580 -300 0 0 {name=p19 lab=VGND}
C {ipin.sym} -580 -280 0 0 {name=p20 lab=VNB}
C {ipin.sym} -580 -260 0 0 {name=p21 lab=VPB}
C {ipin.sym} -580 -240 0 0 {name=p22 lab=VPWR}
C {opin.sym} -540 -340 0 0 {name=p2 lab=Y}
...
C {lab_pin.sym} -530 -210 2 0 {name=p23 sig_type=std_logic lab=VPWR}
C {lab_pin.sym} -530 -90 2 0 {name=p26 sig_type=std_logic lab=VGND}
